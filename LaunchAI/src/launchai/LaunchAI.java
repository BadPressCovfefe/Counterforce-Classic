...
{
    private static final String SERVER_URL = "career.CounterforceGame.com";
    private static final int SERVER_PORT = 30071;
    
    private static final String DESIRED_PLAYER_NAME = "TheBiscuit";
    private static final String LOG_NAME = "Bot";
    private static final String CONFIG_FILENAME = "config.xml";
    
    private LaunchClientGame game;
    
    private GeoCoord geoLocation = new GeoCoord(37, -77, true);
    
    private GeoCoord homeBase = new GeoCoord(37, -77);
    
    private boolean bLoggedIn = false;
    
    private static final float WALKING_SPEED = 5;    
    private static final float RUNNING_SPEED = 12;
    private static final float DRIVING_SPEED = 80;
            ...
            {                
                switch(state)
                {
                    ...
                    {       
                        game.Respawn();
                        state = state.MOVING;
                        //If player is under attack, state = defending. 
                        //if player has atleast $20,000, state = building. 
                        //If player doesn't have one, buy a missile system and interceptor system.
                        //If there is ore nearby, state = collecting.        
                        //If we have enough money, a SAM site, and our defense value is more than double our offense value, state = BUY_INTERCEPTORS
                        //If we have enough money, a missile silo, and our offense value is less than half our defense value, state = BUY_MISSILES
                        //If player has enough money and weapons, state = attacking.
                    }
                    break;
                    ...
                    case COLLECTING:
                    {
                        //if there is ore nearby, move to it. 
                        //If there is no ore nearby, state = idle. 
                    }
                    break;
                    
                    case BUILDING:
                    {
                        //If we have atleast $17,500 and our defnse value is less than our offense value x2, build a sam site. 
                        //If we have atleast $11,000 and we are between structure separation distance and .3 km away from an ore mine, SAM site, or Missile Silo, build a sentry gun.
                        //If we have $20k and we are not in oremine compete radius, build one. 
                        //If we have $130,000 and our defense value is worth more than twice our offense value, build an ICBM silo.                        
                    }
                    break;
    ...
    @Override
    public void ShowBasicOKDialog(String string)
    {
    ...
    @Override
    public boolean GetIsOnScreen(MapEntity me)
    {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public void MissileExploded(Missile msl)
    {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public void InterceptorReachedTarget(Interceptor i)
    {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
