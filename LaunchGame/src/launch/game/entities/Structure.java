 ...
 * @author tobster
 */
public abstract class Structure extends Damagable implements NamableInterface, ResourceInterface
{
    ...
    private int lBuiltByID;
    private ResourceSystem resources;
    
    /** New. */
    public Structure(int lID, GeoCoord geoPosition, short nHP, short nMaxHP, int lOwnerID, boolean bRespawnProtected, int lBootTime, ResourceSystem resources)
    {
        ...
        this.lBuiltByID = lOwnerID;
        this.resources = resources;
        SetBooting();
    }
    
    /** From save. */
    public Structure(int lID, GeoCoord geoPosition, short nHP, short nMaxHP, String strName, int lOwnerID, byte cFlags, int lStateTime, boolean bVisible, int lVisibleTime, int lBuiltByID, ResourceSystem resources)
    {
        super(lID, geoPosition, nHP, nMaxHP, bVisible, lVisibleTime);
        this.strName = strName;
        this.lOwnerID = lOwnerID;
        this.cFlags = cFlags;
        this.lBuiltByID = lBuiltByID;
    ...
    public byte[] GetData(int lAskingID)
    {
        ...
        ByteBuffer bb = ByteBuffer.allocate(DATA_SIZE + cBaseData.length + LaunchUtilities.GetStringDataSize(strName) + cResourceData.length);
        bb.put(cBaseData);
        bb.put(LaunchUtilities.GetStringData(strName));
        bb.putInt(lOwnerID);
        bb.put(cFlags);
        dlyStateTime.GetData(bb);
        bb.putInt(lBuiltByID);
    ...
    {
        return lOwnerID != lBuiltByID;
    }
    
    public int GetBuiltByID()
    {
        return this.lBuiltByID;
    }
