...
{
    private final String SERVER_KEY = "-----BEGIN PRIVATE KEY-----\\*deleted the code from this part so no one sees the token*\\n-----END PRIVATE KEY-----\\n";
    ...
    public String sendToTopic(String topic) throws Exception 
    { //SEND TO TOPIC
    ...
    { // SEND TO GROUP OF PHONES - ARRAY OF TOKENS
    ...
    {//SEND MESSAGE TO SINGLE MOBILE - TO TOKEN
        root.put("to", token);
        return sendPushNotification(false);
    }
