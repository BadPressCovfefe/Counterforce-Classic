...
public class TreatyTask extends Task
{
    ...
    public void Start(TobComm comm)
    {
        switch(type)
        {
            ...
            case SURRENDER_PROPOSAL: comm.SendCommand(LaunchSession.SurrenderWar, lAllianceID); break;
            case CANCEL_AFFILIATION: comm.SendCommand(LaunchSession.CancelAffiliation, lAllianceID); break;
            case REJECT_SURRENDER: comm.SendCommand(LaunchSession.RejectSurrender, lAllianceID); break;
            case ACCEPT_SURRENDER: comm.SendCommand(LaunchSession.AcceptSurrender, lAllianceID); break;
        }
    }
}
