...
public class LaunchUICommon
{
    ...
    {
            Color.parseColor("#82ff82"), // YOU - bright pastel green
            Color.parseColor("#82ffff"), // ALLY - bright pastel cyan
            Color.parseColor("#6c9dff"), // AFFILIATE - bright pastel blue
            Color.parseColor("#ff6363"), // ENEMY - bright pastel red
            Color.parseColor("#ffe866"), // NEUTRAL - bright pastel yellow
            Color.parseColor("#ffa2ff"), // PENDING TREATY - bright pastel magenta/lilac
            Color.parseColor("#EEEEEE")  // UNOWNED/UNAFFILIATED - bright off-white
    };
