...
public class BankView extends StructureView
{
    ...
    protected void Setup()
    {
        ...
        imgLogo.setImageResource(R.drawable.icon_bank);
    ...
    {
        return game.GetBank(structureShadow.GetID());
    }
    ...
    {
        game.SetStructureOnOff(structureShadow.GetID(), EntityType.BANK, bOnline);
    }
}
