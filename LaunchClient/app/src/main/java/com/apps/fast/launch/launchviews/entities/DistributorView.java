...
import com.apps.fast.launch.launchviews.controls.DistributorControl;
...
public class DistributorView extends StructureView
{
    protected LaunchView systemView;

    public DistributorView(LaunchClientGame game, MainActivity activity, LaunchEntity structure)
    {
    ...
    {
        systemView = new DistributorControl(game, activity, structureShadow.GetID());
        ...
        imgLogo.setImageResource(R.drawable.icon_distributor);
    ...
    {
        return game.GetDistributor(structureShadow.GetID());
    }
    ...
    {
        game.SetStructureOnOff(structureShadow.GetID(), EntityType.DISTRIBUTOR, bOnline);
    }
}
