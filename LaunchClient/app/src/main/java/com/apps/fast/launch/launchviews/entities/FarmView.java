...
import com.apps.fast.launch.launchviews.controls.FarmControl;
...
public class FarmView extends StructureView
{
    protected LaunchView systemView;

    public FarmView(LaunchClientGame game, MainActivity activity, LaunchEntity structure)
    {
    ...
    {
        systemView = new FarmControl(game, activity, structureShadow.GetID());
        ...
        imgLogo.setImageResource(R.drawable.build_farm);
    ...
    {
        game.SetStructureOnOff(structureShadow.GetID(), EntityPointer.EntityType.FARM, bOnline);
    }
}
