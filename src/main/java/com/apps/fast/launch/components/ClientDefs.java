...
public class ClientDefs
{
    ...
    /* Live */
    public static final String SETTINGS_SERVER_URL_DEFAULT = "192.168.1.21";
    ...
    public static final String DISCORD_URL = "https://discord.gg/qYV6CtwAGG";
    ...
    private static LinkedList<Integer> MissilePreferences = null;
    private static LinkedList<Integer> InterceptorPreferences = null;
    ...
    public static List<Integer> GetMissilePreferredOrder(Context context)
    {
        ...
        if(sharedPreferences.contains(SETTINGS_PREFERRED_MISSILE_1))
        {
            ...
            MissilePreferences.addLast(sharedPreferences.getInt(SETTINGS_PREFERRED_MISSILE_1, 0));

            if(sharedPreferences.contains(SETTINGS_PREFERRED_MISSILE_2))
                MissilePreferences.addLast(sharedPreferences.getInt(SETTINGS_PREFERRED_MISSILE_2, 0));

            if(sharedPreferences.contains(SETTINGS_PREFERRED_MISSILE_3))
                MissilePreferences.addLast(sharedPreferences.getInt(SETTINGS_PREFERRED_MISSILE_3, 0));
    ...
    public static List<Integer> GetInterceptorPreferredOrder(Context context)
    {
        ...
        if(sharedPreferences.contains(SETTINGS_PREFERRED_INTERCEPTOR_1))
        {
            ...
            InterceptorPreferences.addLast(sharedPreferences.getInt(SETTINGS_PREFERRED_INTERCEPTOR_1, 0));

            if(sharedPreferences.contains(SETTINGS_PREFERRED_INTERCEPTOR_2))
                InterceptorPreferences.addLast(sharedPreferences.getInt(SETTINGS_PREFERRED_INTERCEPTOR_2, 0));

            if(sharedPreferences.contains(SETTINGS_PREFERRED_INTERCEPTOR_3))
                InterceptorPreferences.addLast(sharedPreferences.getInt(SETTINGS_PREFERRED_INTERCEPTOR_3, 0));
    ...
    public static void SetInterceptorPreferred(int lInterceptor)
    {
        //Set a purchased interceptor to go to the top of the preferred list.
        if(InterceptorPreferences == null)
            InterceptorPreferences = new LinkedList<>();

        if(InterceptorPreferences.contains(lInterceptor))
            InterceptorPreferences.remove(lInterceptor);

        InterceptorPreferences.push(lInterceptor);
