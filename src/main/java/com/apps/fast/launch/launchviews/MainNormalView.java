...
public class MainNormalView extends LaunchView
{
    ...
    private ImageView imgShowBunkers;
    ...
    protected void Setup()
    {
        ...
        imgShowBunkers = findViewById(R.id.imgShowBunkers);
        ...
        imgShowBunkers.setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                LaunchUtilities.BUNKERS_VISIBLE = !LaunchUtilities.BUNKERS_VISIBLE;
                MapToolIconsChanged();
                activity.RebuildMap();
            }
        });
            ...
            public void onClick(View view)
            {
                ...
                else
                {
                    ...
                    } else
                    {
                        ...
                        {
                            launchDialog.SetMessage(context.getString(R.string.heal_radiation_confirm, TextUtilities.GetCurrencyString(game.GetHealCost(ourPlayer))));
                        }
                        else
                        {
    ...
    private void MapToolIconsChanged()
    {
        activity.runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                imgShowBunkers.setColorFilter(LaunchUtilities.BUNKERS_VISIBLE? 0 : LaunchUICommon.COLOUR_TINTED);
    ...
    {   //This method causes a null object reference crash. Hopefully the below if statement fixed it. TODO:
        if(entity != null)
        {
            if(bottomView != null)
