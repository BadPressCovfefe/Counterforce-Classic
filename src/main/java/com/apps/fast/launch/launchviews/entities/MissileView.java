    ...
    protected void Setup()
    {
        ...
        if(missile != null)
        {
            ...
            if(missileType != null)
            {
                ...
                txtStealthDescription.setText(context.getString(R.string.stealth_description));
                ...
                imgMissile.setImageBitmap(EntityIconBitmaps.GetMissileBitmap(activity, game, missile, type.GetAssetID()));
