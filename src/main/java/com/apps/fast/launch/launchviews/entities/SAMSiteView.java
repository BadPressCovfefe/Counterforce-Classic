        ...
        if(structureShadow.GetOwnerID() == game.GetOurPlayerID() && !structureShadow.GetSelling())
        {
            ...
            btnApplyEngageDistance.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    ...
                    {
                        game.SetSAMEngagementDistance(structureShadow.GetID(), Float.valueOf(txtEngageDistanceEdit.getText().toString()));
                    }
            ...
            public void run()
            {
                ...
                if(structure != null)
                {
                    if (structureShadow.GetOwnerID() == game.GetOurPlayerID() && !structure.GetSelling() && game.GetOurPlayer().Functioning())
                    {
                            ...
                            txtEngageDistanceButton.setText(String.format("%s (Tap to edit)", TextUtilities.GetDistanceStringFromKM(samSite.GetEngagementDistance())));
