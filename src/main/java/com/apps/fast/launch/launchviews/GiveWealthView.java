        ...
        btnSendWealth.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if(game.GetOurPlayer().GetWealth() >= lAmountToSend && lAmountToSend > 0)
                {
                    ...
                    launchDialog.SetMessage(context.getString(R.string.confirm_give_wealth, TextUtilities.GetCurrencyString(lAmountToSend)));
                    launchDialog.SetOnClickOk(new View.OnClickListener()
                    {
                        @Override
                        public void onClick(View view)
                        {
                            game.GiveWealth(ID, lAmountToSend);
                            launchDialog.dismiss();
                            ReturnToParentView();
                        }
                    });
                ...
                else
                {
                    final LaunchDialog launchDialog = new LaunchDialog();
                    launchDialog.SetHeaderLaunch();
                    launchDialog.SetMessage(context.getString(R.string.insufficient_wealth_transfer));
                    launchDialog.SetOnClickOk(new View.OnClickListener()
                    {
                        @Override
                        public void onClick(View view)
