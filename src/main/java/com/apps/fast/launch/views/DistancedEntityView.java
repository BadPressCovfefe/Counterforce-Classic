...
public class DistancedEntityView extends FrameLayout
{
    ...
    void Setup(MainActivity activity, LaunchEntity entity, LaunchClientGame game)
    {
        ...
        //int mipMapLevel = activity.GetMipMapLevel();
        ...
        {
            imgType.setImageBitmap(StructureIconBitmaps.GetStructureBitmap(activity, game, (Structure)entity, 4));
        ...
        else if(entity instanceof Missile)
        {
            ...
            imgType.setImageBitmap(EntityIconBitmaps.GetMissileBitmap(activity, game, missile, type.GetAssetID()));
            txtEntityName.setText(TextUtilities.GetEntityTypeAndName(entity, game));
        ...
        else if(entity instanceof Interceptor)
        {
            ...
            imgType.setImageBitmap(EntityIconBitmaps.GetInterceptorBitmap(activity, game, interceptor, type.GetAssetID()));
            txtEntityName.setText(TextUtilities.GetEntityTypeAndName(entity, game));
