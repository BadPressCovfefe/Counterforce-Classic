...
public final class ApiServer
{
    ...
    public ApiServer(GameBridge bridge, int httpPort) throws IOException
    {
        ...
        server.createContext("/api/giveeveryoneeverything", withAuth(this::giveEveryoneEverything));
    ...
    private void giveEveryoneEverything(com.sun.net.httpserver.HttpExchange ex) throws IOException
    {
        LaunchServerGame game = launchserver.api.GameAccess.get();
        if(game == null)
        {
        ...
        for(Player player : game.GetPlayers())
        {
            ...
            if(system != null)
            {
                ...
                {
                    system.AddResource(type, 9_999_999);
                    player.SetBoss(true);
                }
            }
            out.append(String.format("Gave %s everything, greedy bastard.%n", player.GetName()));
        }
