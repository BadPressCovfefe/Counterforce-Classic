    ...
    public void Tick()
    {
        ...
        try
        {
            ...
            switch(args[0])
            {
                ...
                case "max_player_inventories":
                {
                    for(Player player : game.GetPlayers())
                    {
                        player.GetCargoSystem().SetCapacity(Long.MAX_VALUE);
                    }
                }
                break;
                ...
                case "giveresources":
                {
                    ...
                    if(system != null)
                    {
                        ...
                        {
                            system.AddResource(type, 1000000);
                        }
                    }
                    
                    LaunchLog.ConsoleMessage(String.format("Gave %s resources.", player.GetName()));
                }
                break;
                
                case "giveeveryoneeverything":
                {
                    for(Player player : game.GetPlayers())
                    {
                        CargoSystem system = player.GetCargoSystem();
                        ...
                        if(system != null)
                        {
                            for(ResourceType type : ResourceType.values())
                            {
                                if(type != ResourceType.NUCLEAR_ELECTRICITY)
                                    system.AddResource(type, 9999999L);
                            }
                        }
                        ...
                        LaunchLog.ConsoleMessage((String.format("Gave %s everything, greedy bastard.", player.GetName())));
                    }
                }
                break;
                ...
                case "launch":
                {
                    ...
                    game.LaunchDebugMissiles(lCount);
                }
                break;
