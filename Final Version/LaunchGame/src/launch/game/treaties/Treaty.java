...
public abstract class Treaty
{
    ...
    public enum Type
    {
        ...
        SURRENDER_PROPOSAL,
        REJECT_SURRENDER,        //Not a type. Exists to simplify diplomacy task code.
        ACCEPT_SURRENDER,        //Not a type. Exists to simplify diplomacy task code.
        CANCEL_AFFILIATION,       //Not a type. Exists to simplify diplomacy task code.
    }
