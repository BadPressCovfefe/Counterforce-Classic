...
public class War extends Treaty
{
     ...
     * @param lAllianceID1 ID of one belligerant.
    ...
    public War(int lID, int lAllianceID1, int lAllianceID2)
    {
        ...
        this.lIncome2 = 0;
        this.oStartTime = System.currentTimeMillis();
    }
    ...
    public boolean Alliance1Forfeited()
    {
        return bForfeited1;
    }
    
    public boolean Alliance2Forfeited()
    {
        return bForfeited2;
    }
}
