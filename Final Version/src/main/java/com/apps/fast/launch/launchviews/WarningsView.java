...
public class WarningsView extends LaunchView
{
    ...
    private FrameLayout lytNoRadar;
    ...
    protected void Setup()
    {
        ...
        lytNoRadar = findViewById(R.id.lytNoRadar);
    ...
    public void Update()
    {
        activity.runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                {
                    bNoProblems = false;
                    lytNoRadar.setVisibility(VISIBLE);
                }
                else
                {
                    lytNoRadar.setVisibility(GONE);
                }
        ...
        if(entity instanceof Player)
        {
            if (entity.GetID() == game.GetOurPlayerID())
            {
                ...
                for(Missile missile : game.GetMissiles())
                {
                    ...
                    if(game.GetStealthMissileVisibility(missile, game.GetOurPlayer()))
                    {
