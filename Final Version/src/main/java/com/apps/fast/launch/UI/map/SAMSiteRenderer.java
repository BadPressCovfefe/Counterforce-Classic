...
public class SAMSiteRenderer extends DefaultClusterRenderer<LaunchClusterItem>
{
    ...
    protected void onBeforeClusterItemRendered(LaunchClusterItem item, MarkerOptions markerOptions)
    {
        ...
        if(samSite != null && game != null)
        {
            ...
            /*if(game.GetRadarAccuracyBonus(samSite) > 0)
            {
                MarkerOptions optRadarBoost = new MarkerOptions();
                optRadarBoost.icon(BitmapDescriptorFactory.fromResource(R.drawable.overlay_radar_boosted));
                optRadarBoost.anchor(0.5f, 0.5f);
            }*/
        }
    }
