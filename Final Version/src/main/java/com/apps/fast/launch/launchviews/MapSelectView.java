...
public class MapSelectView extends LaunchView
{
    ...
    protected void Setup()
    {
        ...
        setupThread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                final List<SolarPanel> OurSolarPanels = new ArrayList<>();
                final List<Bunker> OurBunkers = new ArrayList<>();
                ...
                FillPlayerOrEverythingElseContainer(game.GetSolarPanels(), OurSolarPanels, EverythingElse);
                FillPlayerOrEverythingElseContainer(game.GetBunkers(), OurBunkers, EverythingElse);
                ...
                activity.runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        if(OurBunkers.size() > 0)
                            lytGroups.addView(new StructureMaintenanceView(game, activity, OurBunkers));
    ...
    public void FillPlayerOrEverythingElseContainer(Collection Structures, List OurContainer, List EverythingElse)
    {
        for(Object object : Structures)
        {
            ...
            if(structure.GetPosition().IsInsideGeoRect(geoFrom, geoTo) && game.GetIsInsideRadarRange(structure, game.GetOurPlayer()))
            {
    ...
    public void FillEverythingElseContainer(Collection Structures, List EverythingElse)
    {
        for(Object object : Structures)
        {
            ...
            if(entity.GetPosition().IsInsideGeoRect(geoFrom, geoTo) && game.GetIsInsideRadarRange(entity, game.GetOurPlayer()))
            {
