...
public class TextUtilities
{
    ...
    public static String GetEntityTypeAndName(LaunchEntity entity, LaunchGame game)
    {
        ...
        {
            return context.getString(R.string.bunker);
        }
    ...
    public static String GetOwnedEntityName(LaunchEntity entity, LaunchGame game)
    {
        ...
        if(entity instanceof Missile)
        {
            ...
            if(type.GetStealth())
            {
                return GetMissileAndType(missile, game);
            }
            else
            {
        ...
        else if(entity instanceof MissileSite)
        {
            ...
            {
                MissileSite missileSite = (MissileSite)entity;
                return context.getString(R.string.owners_entity, game.GetPlayer(missileSite.GetOwnerID()).GetName(), context.getString(R.string.nuke_site_title));
            }
            else
            {
                MissileSite missileSite = (MissileSite) entity;
        ...
        else if(entity instanceof SAMSite)
        {
            ...
            if(samSite.GetIsABMSilo())
            {
                return context.getString(R.string.owners_entity, game.GetPlayer(samSite.GetOwnerID()).GetName(), context.getString(R.string.abm_silo_title));
            }
            else
            {
        ...
        else if(entity instanceof RadarStation)
        {
            ...
            return context.getString(R.string.owners_entity, game.GetPlayer(radarStation.GetOwnerID()).GetName(), context.getString(R.string.radar_station_title));
        }
        else if(entity instanceof SolarPanel)
        {
            SolarPanel solarPanel = (SolarPanel)entity;
            return context.getString(R.string.owners_entity, game.GetPlayer(solarPanel.GetOwnerID()).GetName(), context.getString(R.string.solar_panel_title));
        }
        else if(entity instanceof Bunker)
        {
            Bunker bunker = (Bunker)entity;
            return context.getString(R.string.owners_entity, game.GetPlayer(bunker.GetOwnerID()).GetName(), context.getString(R.string.bunker_title));
        }
