...
public class LaunchableSelectionView extends FrameLayout
{
    ...
    public LaunchableSelectionView(MainActivity activity, LaunchClientGame game, InterceptorType type, long oFlightTime, int lSAMSiteID)
    {
        super(activity);
        this.activity = activity;
        this.game = game;
        this.oFlightTime = oFlightTime;
        this.lSAMSiteID = lSAMSiteID;
        bIntercepting = true;
    ...
    private void Setup(MissileType type)
    {
        ...
        TextView txtEMPRadius = (TextView)findViewById(R.id.txtEMPRadius);
        ...
        TextView txtEMPRadiusTitle = (TextView)findViewById(R.id.txtEMPRadiusTitle);
        ...
        ImageView imgICBM = (ImageView)findViewById(R.id.imgICBM);
        ImageView imgStealth = (ImageView)findViewById(R.id.imgStealth);
        ...
        txtSpeed.setText(TextUtilities.GetSpeedFromKph(game.GetConfig().GetMissileSpeed(type)));
        txtCost.setText(TextUtilities.GetCurrencyString(lCost));
        txtEMPRadius.setText(TextUtilities.GetDistanceStringFromKM(type.GetEMPRadius()));
        ...
        txtEMPRadius.setVisibility(type.GetEMPRadius() != 0 ? VISIBLE : GONE);
        ...
        txtEMPRadiusTitle.setVisibility(type.GetEMPRadius() != 0 ? VISIBLE : GONE);
        ...
        if(type.GetStealth())
        {
            imgStealth.setOnClickListener(new OnClickListener()
            {
                ...
                {
                    activity.ShowBasicOKDialog(activity.getString(R.string.stealth_description));
                }
            });
        }
        ...
        if(type.GetICBM())
        {
            imgICBM.setOnClickListener(new OnClickListener()
            {
                @Override
                public void onClick(View view)
                {
                    activity.ShowBasicOKDialog(activity.getString(R.string.ICBM_information));
                }
            });
        }
    ...
    private void Setup(InterceptorType type)
    {
        ...
        TextView txtRange = (TextView)findViewById(R.id.txtRange);
        TextView txtSpeed = (TextView)findViewById(R.id.txtSpeed);
        TextView txtHitChance = (TextView)findViewById(R.id.txtHitChance);
        TextView txtPrepTime = (TextView)findViewById(R.id.txtPrepTime);
        TextView txtFlightTime = (TextView)findViewById(R.id.txtFlightTime);
        TextView txtCost = (TextView)findViewById(R.id.txtCost);
        ...
        txtSpeed.setText(TextUtilities.GetSpeedFromKph(game.GetConfig().GetInterceptorSpeed(type)));
        txtHitChance.setText(TextUtilities.GetAccuracyPercentage(game.GetInterceptorAccuracy(type)));
        txtCost.setText(TextUtilities.GetCurrencyString(lCost));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
        ...
        if(bMissile)
        {
            ...
            TextView txtPrepTimeTitle = (TextView) findViewById(R.id.txtPrepTimeTitle);
            TextView txtFlightTimeTitle = (TextView) findViewById(R.id.txtFlightTimeTitle);
            TextView txtEMPRadiusTitle = (TextView)findViewById(R.id.txtEMPRadius);
