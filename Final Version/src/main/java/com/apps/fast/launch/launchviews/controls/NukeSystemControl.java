 ...
 */
public class NukeSystemControl extends LaunchView implements SlotListener
{
    ...
    public NukeSystemControl(LaunchClientGame game, MainActivity activity, int lHostID, boolean bIsMissiles, boolean bHostIsPlayer)
    {
    ...
    protected void Setup()
    {
        ...
        txtHitChance.setVisibility(GONE);
        txtHitChanceTitle.setVisibility(GONE);
