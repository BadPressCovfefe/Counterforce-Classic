    ...
    protected void Setup()
    {
        ...
        if(interceptor != null)
        {
            ...
            if(interceptorType != null)
            {
                ...
                txtHitChance.setText(TextUtilities.GetAccuracyPercentage(game.GetInterceptorHitChance(interceptor)));
        ...
        activity.runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                if(interceptor != null)
                {
                    ...
                    if(target != null)
                    {
                        if(game.GetStealthMissileVisibility(target, game.GetOurPlayer()))
                        {
                            InterceptorType interceptorType = game.GetConfig().GetInterceptorType(interceptor.GetType());
                        ...
                        {
                            txtIntercepting.setVisibility(GONE);
