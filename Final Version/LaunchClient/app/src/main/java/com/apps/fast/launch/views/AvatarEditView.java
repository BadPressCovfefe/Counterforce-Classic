 ...
 */
public class AvatarEditView extends androidx.appcompat.widget.AppCompatImageView
{
    ...
    public Bitmap GetBitmap()
    {
        ...
        Bitmap bmpCropped = Bitmap.createBitmap(bitmap, Math.max(0, lX), Math.max(0, lY), Math.max(0, lWidth), Math.max(0, lHeight)); //Math.max fixes a crash related to the numbers being negative. -Corbin
