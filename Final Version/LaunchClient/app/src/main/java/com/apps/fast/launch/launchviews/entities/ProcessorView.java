...
public class ProcessorView extends StructureView
{
    protected LaunchView systemView;

    public ProcessorView(LaunchClientGame game, MainActivity activity, LaunchEntity structure)
    {
    ...
    {
        systemView = new ProcessorControl(game, activity, structureShadow.GetID());
        ...
        imgLogo.setImageResource(R.drawable.icon_processor);
    ...
    {
        return game.GetProcessor(structureShadow.GetID());
    }
    ...
    {
        game.SetStructureOnOff(structureShadow.GetID(), EntityType.PROCESSOR, bOnline);
    }
}
