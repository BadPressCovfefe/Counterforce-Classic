...
public class BottomUnitCommand extends LaunchView
{
    ...
    protected void Setup()
    {
        ...
        switch(command)
        {
            ...
            case TURN:
            {
                txtCommandTitle.setText(R.string.title_turn_infantry);
                txtCommandInstructions.setText(R.string.turn_instructions);
                imgCommand.setImageResource(R.drawable.button_turn_infantry);
            }
            break;
        }
