...
public class AircraftSystemControl extends LaunchView
{
    ...
    protected void Setup()
    {
        ...
        if(bOwnedByPlayer)
        {
            ...
            PurchaseButton btnBuildStealthFighter = findViewById(R.id.btnBuildStealthFighter);
            btnBuildStealthFighter.SetUnit(game, activity, host.GetPointer(), EntityType.STEALTH_FIGHTER, ResourceType.FOOD, Defs.STEALTH_FIGHTER_BUILD_COST);

            PurchaseButton btnBuildStealthBomber = findViewById(R.id.btnBuildStealthBomber);
            btnBuildStealthBomber.SetUnit(game, activity, host.GetPointer(), EntityType.STEALTH_BOMBER, ResourceType.FOOD, Defs.STEALTH_BOMBER_BUILD_COST);

            PurchaseButton btnBuildAWACs = findViewById(R.id.btnBuildAWACs);
            btnBuildAWACs.SetUnit(game, activity, host.GetPointer(), EntityType.AWACS, ResourceType.FOOD, Defs.AWACS_BUILD_COST);
            ...
            PurchaseButton btnBuildCargoPlane = findViewById(R.id.btnBuildCargoPlane);
            btnBuildCargoPlane.SetUnit(game, activity, host.GetPointer(), EntityType.CARGO_PLANE, ResourceType.FOOD, Defs.CARGO_PLANE_BUILD_COST);
